...
import the.one.aqtour.m3u8downloader.utils.SPHelper;
...
public class M3U8DownloaderConfig {
    ...
    public static int getConnTimeout(){
        return SPHelper.getInt(TAG_CONN_TIMEOUT, 100 * 1000);
    }
    ...
    public static int getReadTimeout(){
        return SPHelper.getInt(TAG_READ_TIMEOUT, 300 * 60 * 1000);
    }
