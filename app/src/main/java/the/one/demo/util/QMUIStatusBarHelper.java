...
public class QMUIStatusBarHelper {
    ...
    private static final String TAG = "QMUIStatusBarHelper";
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        Log.e(TAG, "setStatusBarLightMode: mStatuBarType = "+ mStatuBarType);
        if (mStatuBarType != STATUSBAR_TYPE_DEFAULT) {
            Log.e(TAG, "setStatusBarLightMode: mStatuBarType != STATUSBAR_TYPE_DEFAULT" );
    ...
    public static boolean setStatusBarDarkMode(Activity activity) {
        ...
        if (mStatuBarType == STATUSBAR_TYPE_DEFAULT) {
            // 默认状态，不需要处理
            Log.e(TAG, "setStatusBarDarkMode: mStatuBarType == STATUSBAR_TYPE_DEFAULT" );
            return true;
        }
        ...
        if (mStatuBarType == STATUSBAR_TYPE_MIUI) {
            ...
            Log.e(TAG, "setStatusBarDarkMode: mStatuBarType == STATUSBAR_TYPE_FLYME" );
    ...
    private static boolean Android6SetStatusBarLightMode(Window window, boolean light) {
        ...
        Log.e(TAG, "Android6SetStatusBarLightMode: " );
    ...
    public static boolean FlymeSetStatusBarLightMode(Window window, boolean light) {
        ...
        if (window != null) {
            ...
            try {
                ...
                result = true;
                Log.e(TAG, "FlymeSetStatusBarLightMode: "+result );
            } catch (Exception ignored) {
