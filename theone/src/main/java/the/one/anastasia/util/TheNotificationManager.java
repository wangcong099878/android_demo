 ...
 */
public class TheNotificationManager {
    ...
    public static TheNotificationManager theNotificationManager;
    public static Context mContext;

    private NotificationManager NotificationManager;


    public static TheNotificationManager getInstance(Context context){
        if(null == theNotificationManager)
            theNotificationManager = new TheNotificationManager();
        mContext = context;
