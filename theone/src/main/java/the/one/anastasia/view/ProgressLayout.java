...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarWidth, 100);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarHeight, 100);
        ...
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_emptyImageWidth, ViewGroup.LayoutParams.WRAP_CONTENT);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_emptyImageHeight, ViewGroup.LayoutParams.WRAP_CONTENT);

        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_emptyTitleTextSize, defaultTextSize);

        emptyStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_emptyContentTextSize, defaultTextSize);

        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_emptyTitleTextColor, ContextCompat.getColor(getContext(),defaultTextColor));

        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_emptyContentTextColor, ContextCompat.getColor(getContext(),defaultTextColor));
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_errorImageWidth, ViewGroup.LayoutParams.WRAP_CONTENT);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_errorImageHeight, ViewGroup.LayoutParams.WRAP_CONTENT);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_errorTitleTextSize, defaultTextSize);

        errorStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_errorContentTextSize, defaultTextSize);

        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorTitleTextColor, ContextCompat.getColor(getContext(),defaultTextColor));

        errorStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorContentTextColor, ContextCompat.getColor(getContext(),defaultTextColor));
    ...
    public void showEmpty(Drawable emptyImageDrawable, String emptyTextTitle, String emptyTextContent, OnClickListener onClickListener, List<Integer> skipIds) {
        switchState(EMPTY, emptyImageDrawable, emptyTextTitle, emptyTextContent, "",onClickListener, skipIds);
    }
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            loadingStateProgressBar =  view.findViewById(R.id.loadingStateProgressBar);
