package the.one.anastasia.service;
...
import the.one.anastasia.util.AppInfoManager;
import the.one.anastasia.util.TheBroadCastUtil;
import the.one.anastasia.util.TheFileDirectoryUtil;
import the.one.anastasia.util.TheNotificationManager;
...
public class UpdateApkService extends Service   {
    ...
    private TheNotificationManager theNotificationManager;
    ...
    private void startDown() {
        OkHttpUtils
                ...
                .tag(TAG)
                .build()
                .execute(new FileCallBack(TheFileDirectoryUtil.getDownloadPath(), TheFileDirectoryUtil.UPDATE_APK_NAME) {

                    @Override
                    public void onError(Call call, Exception e, int id) {
                        Log.e(TAG, "   下载失败");
                        TheBroadCastUtil.send(UpdateApkService.this,DOWNLOAD_ERROR,DOWNLOAD_ERROR_MSG,e.getMessage());
                    ...
                    public void inProgress(float progress, long total, int id) {
                        ...
                        if (percent != oldPercent) {
                            ...
                            TheBroadCastUtil.send(UpdateApkService.this,UPDATE_PROGRESS,UPDATE_PROGRESS_PERCENT,percent+"");
                        }
                    }
                    ...
                    public void onResponse(File response, int id) {
                        ...
                        TheBroadCastUtil.send(UpdateApkService.this,DOWNLOAD_OK);
    ...
    private void initNotify() {
        theNotificationManager = TheNotificationManager.getInstance(this);
        mBuilder = theNotificationManager.createNotification(NOTIFICATION_ID,
                TheNotificationManager.LEVEL_DEFAULT_CHANNEL_ID,
                "开始下载",
                "正在下载",
                null,
