...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#AAAAAA");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int) QMUIDisplayHelper.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = QMUIDisplayHelper.dp2px(getContext(), DEF_DRAW_SIZE);
