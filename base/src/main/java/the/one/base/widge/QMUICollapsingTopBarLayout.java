...
public class QMUICollapsingTopBarLayout extends FrameLayout implements IWindowInsetLayout {
    ...
    public QMUICollapsingTopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout, defStyleAttr, 0);

        mCollapsingTextHelper.setExpandedTextGravity(
                a.getInt(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleGravity,
                        Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM));
        mCollapsingTextHelper.setCollapsedTextGravity(
                a.getInt(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_collapsedTitleGravity,
                        GravityCompat.START | Gravity.CENTER_VERTICAL));


        mExpandedMarginStart = mExpandedMarginTop = mExpandedMarginEnd = mExpandedMarginBottom =
                a.getDimensionPixelSize(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMargin, 0);

        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginStart)) {
            mExpandedMarginStart = a.getDimensionPixelSize(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginStart, 0);
        }
        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginEnd)) {
            mExpandedMarginEnd = a.getDimensionPixelSize(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginEnd, 0);
        }
        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginTop)) {
            mExpandedMarginTop = a.getDimensionPixelSize(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginTop, 0);
        }
        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginBottom)) {
            mExpandedMarginBottom = a.getDimensionPixelSize(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleMarginBottom, 0);
        }

        mCollapsingTitleEnabled = a.getBoolean(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_titleEnabled, true);
        setTitle(a.getText(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_title));

        // First load the default text appearances
        mCollapsingTextHelper.setExpandedTextAppearance(com.qmuiteam.qmui.R.style.QMUI_CollapsingTopBarLayoutExpanded);
        mCollapsingTextHelper.setCollapsedTextAppearance(com.qmuiteam.qmui.R.style.QMUI_CollapsingTopBarLayoutCollapsed);

        // Now overlay any custom text appearances
        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleTextAppearance)) {
            mCollapsingTextHelper.setExpandedTextAppearance(
                    a.getResourceId(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_expandedTitleTextAppearance, 0));
        }
        if (a.hasValue(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_collapsedTitleTextAppearance)) {
            mCollapsingTextHelper.setCollapsedTextAppearance(
                    a.getResourceId(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_collapsedTitleTextAppearance, 0));
        }

        mScrimVisibleHeightTrigger = a.getDimensionPixelSize(
                com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_scrimVisibleHeightTrigger, -1);

        mScrimAnimationDuration = a.getInt(
                com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_scrimAnimationDuration,
                DEFAULT_SCRIM_ANIMATION_DURATION);

        setContentScrim(a.getDrawable(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_contentScrim));
        setStatusBarScrim(a.getDrawable(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_statusBarScrim));

        mTopBarId = a.getResourceId(com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_qmui_topBarId, -1);
...
//            mTmpRect.top = mTmpRect.top - topBarInsetAdjustTop;
    ...
    static QMUIViewOffsetHelper getViewOffsetHelper(View view) {
        QMUIViewOffsetHelper offsetHelper = (QMUIViewOffsetHelper) view.getTag(com.qmuiteam.qmui.R.id.qmui_view_offset_helper);
        if (offsetHelper == null) {
            offsetHelper = new QMUIViewOffsetHelper(view);
            view.setTag(com.qmuiteam.qmui.R.id.qmui_view_offset_helper, offsetHelper);
        }
        return offsetHelper;
    }
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_Layout);
            mCollapseMode = a.getInt(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_Layout_qmui_layout_collapseMode,
                    COLLAPSE_MODE_OFF);
            setParallaxMultiplier(a.getFloat(
                    com.qmuiteam.qmui.R.styleable.QMUICollapsingTopBarLayout_Layout_qmui_layout_collapseParallaxMultiplier,
