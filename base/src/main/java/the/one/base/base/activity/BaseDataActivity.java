 ...
 * @remark
 */
public abstract class BaseDataActivity<T> extends BaseActivity implements BaseDataView<T>, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemLongClickListener{
    ...
    private void initRecycleView() {
        switch (setType()) {
            case TYPE_LIST:
                ...
                break;
            case TYPE_GRID:
                layoutManager = new GridLayoutManager(this, setColumn());
                break;
            case TYPE_STAGGERED:
