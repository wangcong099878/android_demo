...
public final class CrashUtil {
                            ...
                            if (config.isEnabled()) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    if (isStackTraceLikelyConflictive(throwable, errorActivityClass)) {
                                        ...
                                        String stackTraceString = CrashThrowableParseUtil.parseCrash(throwable);
    ...
    public static String getStackTraceFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(CrashUtil.EXTRA_STACK_TRACE);
    }
    ...
    public static CrashConfig getConfigFromIntent(@NonNull Intent intent) {
        CrashConfig config = (CrashConfig) intent.getSerializableExtra(CrashUtil.EXTRA_CONFIG);
    ...
    public static String getActivityLogFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(CrashUtil.EXTRA_ACTIVITY_LOG);
    }
    ...
    public static String getAllErrorDetailsFromIntent(@NonNull Context context, @NonNull Intent intent) {
        ...
        errorDetails += "Crash date: " + dateFormat.format(currentDate) + " \n";
