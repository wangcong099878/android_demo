...
public class CrashConfig implements Serializable {
    ...
    private CrashUtil.EventListener eventListener = null;
    ...
    @Nullable
    public CrashUtil.EventListener getEventListener() {
        return eventListener;
    }

    public void setEventListener(@Nullable CrashUtil.EventListener eventListener) {
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            CrashConfig currentConfig = CrashUtil.getConfig();
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable CrashUtil.EventListener eventListener) {
